...
fn save_all_yowords(wikipedia_yowords: &Vec<YowordInfo>) {
...
fn create_additions(wikipedia_yowords: &Vec<YowordInfo>, hcodes_safe: &HashSet<String>, hcodes_not_safe: &HashSet<String>) {
    let hcodes_additions = wikipedia_yowords.into_iter()
