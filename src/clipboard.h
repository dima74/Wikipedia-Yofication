#ifndef PARSE_CLIPBOARD_H
#define PARSE_CLIPBOARD_H
...
struct Clipboard {
    ...
    void XCopy(Atom selection, unsigned char *text, int size) {
        XEvent event;
        Window owner;
...
//    }
    ...
    void copy(string text) {
        ...
        XCopy(selection, (unsigned char *) text.c_str(), text.length());
    }
};
