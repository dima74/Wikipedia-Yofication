...
def getReplaces(info, title, min_replace_frequency):
    ...
    p = Popen(['/home/dima/Wikipedia-Yofication/cmake-build-debug/replaces_printer_for_page'], stdout=PIPE, stdin=PIPE, stderr=STDOUT, cwd=r'/home/dima/Wikipedia-Yofication')
